...
function updateDiagnostics(anovaStats, groups) {
    ...
    container.innerHTML = `
        <div class="diagnostic-section">
            <p class="diagnostic-status ${varianceStatus}">Variance homogeneity</p>
            <ul>
                <li>Largest SD ÷ smallest SD = ${varRatio.toFixed(2)}</li>
                <li>${varianceMessage}</li>
            </ul>
        </div>
        <div class="diagnostic-section">
            <p class="diagnostic-status ${normalityStatus}">Approximate normality</p>
            <ul>
                <li>Smallest group n = ${smallestN}</li>
                <li>${normalityMessage}</li>
            </ul>
        </div>
        <div class="diagnostic-section">
            <p class="diagnostic-status ${balanceStatus}">Sample balance</p>
            <ul>
                <li>Largest n ÷ smallest n = ${balanceRatio.toFixed(2)}</li>
        ...
        <div class="diagnostic-section">
            ...
            <ul>
                <li>The analysis assumes each observation is independent. Review the sampling plan to ensure this holds before acting.</li>
            </ul>
        </div>
        <div class="diagnostic-section">
            <p class="diagnostic-status ${overallStatus}">Overall recommendation</p>
            <p>${overallMessage}</p>
        </div>
    `;
}
